...
<head>
    ...
    <title>@yield('title', 'Admin') - {{ config('app.name', 'Sampah') }}</title>
    ...
    <div class="layout-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('master_kategori_sampah.index') }}" class="{{ request()->routeIs('master_kategori_sampah.*') ? 'active' : '' }}">
                    📋 Master Kategori
                </a>
                <a href="{{ route('kategori_sampah.index') }}" class="{{ request()->routeIs('kategori_sampah.*') ? 'active' : '' }}">
                    🏷️ Kategori Sampah
                </a>
            </nav>
        </aside>
