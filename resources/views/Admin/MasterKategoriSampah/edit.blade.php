...
<div class="page-bg">
    <div class="wrap">
        ...
        <div class="card">
            <form method="POST" action="{{ route('master_kategori_sampah.update', $item->id) }}">
                @csrf
                @method('PUT')

                <div class="row">
                    <label>Nama Kategori *</label>
                    <input type="text" name="nama_kategori" value="{{ old('nama_kategori', $item->nama_kategori) }}" required>
                </div>
