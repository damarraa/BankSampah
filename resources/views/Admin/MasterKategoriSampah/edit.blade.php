...
@section('content')
    <div class="form-container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">Perbarui informasi kategori master sampah.</p>
        </div>
        ...
        @if ($errors->any())
            <div
                ...
                <div>
                    <div style="font-weight:700; color:#991b1b; margin-bottom:4px;">Gagal menyimpan perubahan</div>
        ...
        <form action="{{ route('master_kategori_sampah.update', $item->id) }}" method="POST" id="mainForm">
            @csrf
            ...
            <div class="form-card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kategori" id="nama_kategori"
                            ...
                            placeholder="Contoh: Plastik, Logam, Elektronik" maxlength="50" required>

                        <div class="input-footer">
                            <span class="form-text">Nama kategori utama.</span>
                    ...
                    <div class="form-group" style="margin-bottom:0;">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control @error('deskripsi') is-invalid @enderror"
                            placeholder="Jelaskan jenis sampah apa saja yang masuk kategori ini..." maxlength="255">{{ old('deskripsi', $item->deskripsi) }}</textarea>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnSubmit">
                        ...
                        <span><i class="fa-solid fa-check"></i> Simpan Perubahan</span>
                    </button>
                </div>
            </div>
        </form>
